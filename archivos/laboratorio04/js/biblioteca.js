...
//creamos un funcion para validar nombre
...
function Validar(){
    ...
    LlamarClase("Por favor ingrese sus apellidos ");
    LlamarClase("Por favor ingrese su correo ");
    LlamarClase("Por favor selccione su sexo ");
    LlamarClase("Por favor selccione su estado");
    txtApe.focus();
    ...
    LlamarClase("Por favor ingrese su sexo ");
